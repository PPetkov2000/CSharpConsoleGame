...
namespace Game
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            RangedWeapon shield = new RangedWeapon(type: "Shield", durability: 100, damage: 10, weight: 10, range: 50, ammo: int.MaxValue, ammoCapacity: int.MaxValue, maxBlockDamage: 200);
            ...
            RangedWarrior hawkeye = new RangedWarrior(name: "Hawkeye", health: 100, attackDamage: 10, armor: 0, blockChance: 10, weapons: hawkEyeWeapons);
            RangedWarrior blackWidow = new RangedWarrior(name: "Black Widow", health: 100, attackDamage: 10, armor: 0, blockChance: 10, weapons: blackWidowWeapons);
