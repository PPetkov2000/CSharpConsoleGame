...
namespace Game
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DefenceWeapon shield = new DefenceWeapon(type: "Shield", durability: 100, damage: 10, weight: 10, blockChance: 90, maxBlockDamage: 200);
            ...
            MeleeWeapon axe = new MeleeWeapon(type: "Axe", durability: 100, damage: 80, weight: 20, blockChance: 15);
            ...
            MeleeWarrior thor = new MeleeWarrior(name: "Thor", health: 300, attackDamage: 50, armor: 30, blockChance: 10, weapons: thorWeapons);
            MagicWarrior loki = new MagicWarrior(name: "Loki", health: 200, attackDamage: 30, armor: 10, blockChance: 10, weapons: lokiWeapons);
            MeleeWarrior hulk = new MeleeWarrior(name: "Hulk", health: 1000, attackDamage: 200, armor: 10, blockChance: 10);
            MeleeWarrior captainAmerica = new MeleeWarrior(name: "Captain America", health: 100, attackDamage: 20, armor: 20, blockChance: 10, weapons: captainAmericaWeapons);
            MeleeWarrior ironMan = new MeleeWarrior(name: "Iron Man", health: 100, attackDamage: 40, armor: 80, blockChance: 10);
            ...
            thor.Equip(thorWeapons);
            loki.Equip(lokiWeapons);
